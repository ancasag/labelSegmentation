...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        utils.addActions(#menu file de la barra de herramientas
            self.menus.file,
            (
                open_,
                openNextImg,
        ...
        utils.addActions(self.menus.help, (help,))#menu help en barra de herramientas
        utils.addActions(
            self.menus.view,#menu view de la barra de herramientas
            (
        ...
        self.tools = self.toolbar("Tools")#barra de botones
        self.actions.tool = (
            open_,
            opendir,
            openPrevImg,
    ...
    def populateModeActions(self):
        ...
        actions = (
            ...
            #self.actions.createmask,
            #self.actions.createExcel
        )
